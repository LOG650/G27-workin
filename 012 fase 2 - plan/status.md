...
- [x] Revidere analyse, tekst og figurer — alle 6 må-tiltak (T-01 til T-06) lukket 2026-05-04: justert problemstilling, multi-step/én-steg-frem-asymmetri eksplisitt, tabellnummerering renummerert konsistent, sentence-case fikset i 4 APA-poster, ny etikk-seksjon i kap. 5.5, konklusjon utvidet med delproblem 1
- [ ] Gjennomføre review og lukke aktiviteten (M-05) — gjenstår: vurdere bør-tiltak (T-07 til T-10) og kan-vurderes (T-11, T-12)
...
7. Intern review av kap. 10 (Konklusjon) gjennomført og lukket 2026-04-30: 3 prioritet 1, 3 prioritet 2 og 2 prioritet 3-tiltak adressert (totalt 8 tiltak). Hovedendringer: åpningsavsnittet resirkulerer nå hovedproblemstillingen og delproblem 2/3 eksplisitt, trenings-/testsplitt (218/42) presisert; «fire av fem modeller» korrigert til «fem av seks modeller på toppdager (alle unntatt RF uten lag_1)»; «Videre arbeid»-paragrafen konvertert til prosa-intro med tre nummererte områder; ferskvarer-anbefalingen begrunnet med kort holdbarhet og svinn; «(10 lags)» harmonisert til «(10 etterslep / lags)» i konklusjon 4; konklusjon 5-etiketten endret til «Metodisk lærdom (jf. kap. 9.1):» for tydeligere forankring; kryssreferanse til kap. 9.5 lagt til i konklusjon 1.
8. Intern review av kap. 11 (Bibliografi) og 12 (Vedlegg) gjennomført og lukket 2026-04-30: 2 prioritet 1, 4 prioritet 2 og 3 prioritet 3-tiltak adressert (totalt 9 tiltak). Hovedendringer: Pandas (McKinney 2010), Statsmodels (Seabold & Perktold 2010) og Scikit-learn (Pedregosa et al. 2011) nå med formelle in-tekst-sitater i kap. 5.2 l. 308; Seiringer-entry korrigert fra 2024 til 2022 og DOI 10.1007/978-3-031-08623-6_62 lagt til (Operations Research Proceedings 2021, Springer); 5 in-tekst-sitater oppdatert tilsvarende; A2-tabell konvertert til (P,D,Q)_5-notasjon og presisjonsnote om hovedtekstens avrundede AIC; A3 med Sklearn-defaults-referanse; A4 med kryssreferanser til kap. 7.2 og 9.3; A5 med random_state-reproduserbarhet-note; A7 med presis scenario_sammendrag.csv-beskrivelse; figuren `fig3_lagerstatus.png` omdøpt med `git mv` til `fig_a8_lagerstatus.png` (A7- og A8-referanser oppdatert). Egen mappe `003 references/artikler/` opprettet med komplett nedlastingsindeks (DOI/URL, foreslåtte filnavn, tilgangsstatus per kilde) for alle 18 referanser; PDF-er lastes ned manuelt av brukeren.
